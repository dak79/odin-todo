 ...
 */
const listsBtn = (list) => {
  const btnTitle = btnsUi(
    list,
    'title',
    ['btns', 'lists-btns', 'text-btns'],
    `List title button: ${list.title}`
  );
  ...
  const btnEdit = btnsUi(
    list,
    'edit',
    ['btns', 'svg-btns', 'svg-btns-edit'],
    `Edit list: ${list.title}`
  );

  const btnDelete = btnsUi(
    list,
    'delete',
    ['btns', 'svg-btns', 'svg-btns-delete'],
