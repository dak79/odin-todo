...
const taskItem = (task) => {
  ...
  const expandTaskBtn = btnsUi(
    task,
    'expand',
    ['btns', 'expand-btn', 'svg-btns'],
    'Show task details'
  );
  ...
  if (task.dueDate) {
    const deleteDateBtn = btnsUi(
      { id: task.id, type: 'due-date' },
      'delete',
      ['btns', 'due-date-delete-btn', 'svg-btns'],
      'Delete date'
    );

    wrapperDueDate.appendChild(deleteDateBtn);
  } else {
    const editDateBtn = btnsUi(
      { id: task.id, type: 'due-date' },
      'edit',
      ['btns', 'due-date-edit-btn', 'svg-btns'],
      'Edit date'
    );
  ...
  const editTaskBtn = btnsUi(
    task,
    'edit',
    ['btns', 'task-edit-btn', 'svg-btns'],
    `Edit task: ${task.title}`
  );

  const deleteTaskBtn = btnsUi(
    task,
    'delete',
    ['btns', 'task-delete-btn', 'svg-btns'],
...
export const expandTaskUi = (task) => {
  ...
  const checkListBtn = btnsUi(
    { id: task.id, type: 'checklist' },
    'new',
    ['btns', 'round-btns', 'round-btns-small'],
