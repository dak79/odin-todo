...
export const exampleTasks = () => {
    ...
    const todoTwo = new Task('Organize Meeting', 'Introduce new teammate', new Date(2022, 10, 15), 2, ['Send invitations', 'Prepare short presentation']);
    const todoThree = new Task('Pay Bills', 'Pay electricity and gas bills', new Date(2022, 10, 6), 3, ['Electric Bill', 'Gas Bill']);
