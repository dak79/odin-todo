...
export const exampleTasks = () => {
    ...
    const todoFour = new Task('ToDo App', 'The Odin Project To Do App', new Date('2023-7-8'), 1, ['Code Design', 'Classes', 'Ui', 'Logic', 'Set up webpack']);
    todoFour.add(tasks);
    ...
    const todoEight = new Task('Mail', 'Send me mail please', new Date('2022-12-08'), 1, ['Take metro']);
    todoEight.add(tasks);
