...
export const exampleTasks = () => {
    ...
    const todoFive = new Task('Passport - Date null control', 'Kaya Passport', null, 'low', [new Checklist(5, 'Print Document'), new Checklist(5, 'Send document by mail')]);
    todoFive.add(tasks);

    const todoSix = new Task('Call Police - In late control', 'Driving Licence', new Date('2022-10-28'), 'medium', [new Checklist(6, 'Print Document'), new Checklist(6, 'Send document by mail'), new Checklist(6, 'Bring document to police')]);
    todoSix.add(tasks);
